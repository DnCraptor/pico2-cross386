...
u32 current_video_mode = 3; // 80*25
/*
CH:
Bit(s)	Описание
...
*/
u16 text_cursor_type = 0x1018; // мигающий курсор внизу строки.
/*
...
u32 x86_int10_hanler_C(u32 eax, u32 ebx, u32 ecx, u32 edx) {
    goutf(TEXTMODE_ROWS - 1, false, "x86_int10_hanler_C(%08X, %08X, %08X, %08X)", eax, ebx, ecx, edx);
